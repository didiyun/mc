...
import (
	...
	"github.com/didiyun/mc/pkg/hookreader"
	"github.com/didiyun/mc/pkg/ioutils"
...
func (f *fsClient) GetObjetPartsInfo() (partsInfo map[int]minio.ObjectPart, err error) {
	return nil, nil
}

func (f *fsClient) ReadAt(b []byte, offset int64) (err error) {
	return nil
}
