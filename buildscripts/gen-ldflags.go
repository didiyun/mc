...
func genLDFlags(version string) string {
	...
	ldflagsStr = ldflagsStr + "-X github.com/didiyun/mc/cmd.ReleaseTag=" + releaseTag(version) + " "
	ldflagsStr = ldflagsStr + "-X github.com/didiyun/mc/cmd.CommitID=" + commitID() + " "
	ldflagsStr = ldflagsStr + "-X github.com/didiyun/mc/cmd.ShortCommitID=" + commitID()[:12]
	return ldflagsStr
}
